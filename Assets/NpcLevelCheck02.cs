...
public class NPCLevelCheck02 : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D other)
    {
        if (other.CompareTag("Player"))
        {
            ...
            animator.speed = 0.5f;
              ...
              if (!dialoguePanel.activeInHierarchy && playerExperience.currentXP < 1600 )
            {
            ...
            if(!dialoguePanel.activeInHierarchy && playerExperience.currentXP >= 1600 && alreadyTriggered == false)
            {
