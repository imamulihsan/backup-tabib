 ...
 SpawnEnemy spawnEnemy;
  ...
  public Transform enemyThreshold;
     ...
     public void OnTriggerEnter2D (Collider2D other)
    {
        ...
        {
                targetDetector.targetDetectionRange =9f;
         ...
         foreach (Transform enemy in Enemy)
            {
                Vector2 randomPosition = new Vector2(
                    Random.Range(enemyThreshold.transform.position.x - randomRangeX, enemyThreshold.transform.position.x + randomRangeX - 5) ,
