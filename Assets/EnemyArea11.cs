...
public class EnemyArea11 : MonoBehaviour
{
  bool canChase = false;
 ...
 SpawnEnemy spawnEnemy;
  ...
  public Transform enemyThreshold;
    ...
    {   
        ...
        GameObject[] enemyObjects = GameObject.FindGameObjectsWithTag("Enemy11");
         ...
         foreach (Transform enemy in Enemy)
            {
                Vector2 randomPosition = new Vector2(
                    Random.Range(enemyThreshold.transform.position.x - randomRangeX  , enemyThreshold.transform.position.x + randomRangeX -6  ),
                    Random.Range(enemyThreshold.transform.position.y - randomRangeY , enemyThreshold.transform.position.y + randomRangeY -4 )
                );
