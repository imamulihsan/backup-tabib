...
public class EnemyArea2 : MonoBehaviour
{
  bool canChase = false;
         ...
         foreach (Transform enemy in Enemy)
            {
                Vector2 randomPosition = new Vector2(
                    Random.Range(enemyThreshold.transform.position.x - randomRangeX +7 , enemyThreshold.transform.position.x + randomRangeX),
                    Random.Range(enemyThreshold.transform.position.y - randomRangeY -5, enemyThreshold.transform.position.y + randomRangeY )
                );
