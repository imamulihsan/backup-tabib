...
public class EnemyArea12 : MonoBehaviour
{
  bool canChase = false;
 ...
 SpawnEnemy spawnEnemy;
  ...
  public Transform enemyThreshold;
    ...
    {   
        ...
        GameObject[] enemyObjects = GameObject.FindGameObjectsWithTag("Enemy12");
         ...
         foreach (Transform enemy in Enemy)
            {
                Vector2 randomPosition = new Vector2(
                    Random.Range(enemyThreshold.transform.position.x - randomRangeX +6 , enemyThreshold.transform.position.x + randomRangeX   ),
                    Random.Range(enemyThreshold.transform.position.y - randomRangeY , enemyThreshold.transform.position.y + randomRangeY -6 )
                );
